...
export const getIovR1DataApiMethod = (
  { startDate, endDate, checkedMonitor, checkedER, checkedTransfer },
  options = {},
) =>
  sendRequest(
    `${BASE_PATH}/get-iov-r1-spreadsheet?startDate=${startDate}&endDate=${endDate}&checkedMonitor=${checkedMonitor}&checkedER=${checkedER}&checkedTransfer=${checkedTransfer}`,
    {
      method: 'GET',
      ...options,
    },
